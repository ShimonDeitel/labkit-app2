...
final class Store: ObservableObject {
    ...
    private let fileName = "labkit_entries.json"
    ...
    static func seedData() -> [Entry] {
        let now = Date()
        return [
            Entry(title: "Sample Supply Item One", detail: "First example entry.", date: now),
            Entry(title: "Sample Supply Item Two", detail: "Second example entry.", date: now.addingTimeInterval(-86400)),
            Entry(title: "Sample Supply Item Three", detail: "Third example entry.", date: now.addingTimeInterval(-172800)),
        ]
    }
}
